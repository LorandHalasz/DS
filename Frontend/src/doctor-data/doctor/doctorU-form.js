...
class PatientFormUpdate extends React.Component{
        ...
        if(updateUser !== null){
            ...
            this.setState({
                formControls: {
                    ...
                    medicalRecord: {value: updateUser.medicalRecord},
                    ...
                    caregiverName: {value: updateUser.caregiverName}
                }
            });
    ...
    upPatient(doctor){
        axios.put(HOST.backend_api + "/patient/updatePatient", doctor)
            .then(response => {
