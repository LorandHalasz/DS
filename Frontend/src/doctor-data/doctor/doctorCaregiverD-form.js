...
class CaregiverDForm extends React.Component{
    ...
    handleSubmit(){
        ...
        axios.delete(HOST.backend_api + "/user/deleteCaregiver/" + username)
            .then(response => {
       ...
       this.props.history.push("/doctors_page2");
