 ...
 * 
 */
@WebServiceClient(name = "DoctorServiceImplService", targetNamespace = "http://services.assignment4.sd.com/", wsdlLocation = "http://localhost:9557/ws/doctor?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DOCTORSERVICEIMPLSERVICE_QNAME = new QName("http://services.assignment4.sd.com/", "DoctorServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9557/ws/doctor?wsdl");
     ...
     * 
     * @return
     *     returns DoctorServiceImpl
     */
    @WebEndpoint(name = "DoctorServiceImplPort")
    public DoctorServiceImpl getDoctorServiceImplPort() {
        return super.getPort(new QName("http://services.assignment4.sd.com/", "DoctorServiceImplPort"), DoctorServiceImpl.class);
    }
     ...
     */
    @WebEndpoint(name = "DoctorServiceImplPort")
    public DoctorServiceImpl getDoctorServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.assignment4.sd.com/", "DoctorServiceImplPort"), DoctorServiceImpl.class, features);
    }
